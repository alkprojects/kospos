...
| File | Scope | Feeds |
|---|---|---|
| [`internal-claude-setup-audit.md`](internal-claude-setup-audit.md) | Session 19 audit of memory, canonical docs, hooks/settings, session log, repo organization, workflow patterns | Periodic-audit cadence (per WORKFLOW.md § Audit cadence); ADR-010 through ADR-015 surfaced from this audit's Area B |
